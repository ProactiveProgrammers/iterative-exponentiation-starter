...
learn more about this assignment by reading the [Iterative
Exponentiation](https://proactiveprogrammers.com/discrete-structures/engineering-efforts/iterative-exponentiation/)
...
- Specifically, you can change into the program directory by typing `cd search`.
- Install the dependencies for the project by typing `poetry install`.
- Run the program by typing a command line the following one:
